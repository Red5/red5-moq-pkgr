 ...
 *
 * Provides audio metadata useful to consume the AAC-LC audio carried in the payload.
 *
 * Fields (all varints):
 ...
 *
 * MUST be present in all objects where media type = Audio AAC-LC in MPEG4 (0x3).
 *
 * Reference: draft-cenzano-moq-media-interop-03 Section 2.4.6
 */
public class AacLcDataExtension extends MoqMIHeaderExtension {

    public static final int EXTENSION_ID = 0x13;
    ...
    public AacLcDataExtension() {
        super(EXTENSION_ID);
    }

    public AacLcDataExtension(long seqId, long ptsTimestamp, long timebase,
